...
- **H7 (drill de restauración) / H8 (activar PITR)** — bloqueados por infra no autorizada. Código y procedimiento listos (`scripts/restore-verify.mjs`, `docs/p2/14-backup-y-restauracion.md`); el drill se corre en cuanto haya un proyecto Supabase donde restaurar. Falta la aceptación formal del RPO de 24 h o la aprobación de PITR (~$100/mes).
- **J** (pruebas de aceptación bajo carga con k6) — necesita API keys reales para ejercer los flujos de IA.
