...
// reciba contenido de documentos/terceros (bases de licitación, respuestas
// de licitantes, documentos corporativos, etc.). Ese contenido nunca es
// confiable: un documento puede contener texto deliberadamente diseñado
// para hacerse pasar por una instrucción del sistema. Este bloque se
// antepone a CADA system prompt que procese contenido externo.
